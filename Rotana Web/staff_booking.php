<?php
// staff_booking.php â€” Staff bookings (list + in-page detail)
session_start();
...
<head>
  ...
  <style>
    ...
    .dropdown-menu.filter-panel{width:360px;max-width:85vw;border:1px solid #000;border-radius:.5rem;padding:.5rem .75rem;}
    ...
    .chip{display:inline-block;background:#5b5bf0;color:#fff;border-radius:16px;padding:.35rem .8rem;font-weight:700;margin-right:.4rem;cursor:pointer;user-select:none}
    .chip.secondary{background:#6c47ff}
    ...
    .btn-back{background:#3ea8ff;border:0;font-weight:800;border-radius:999px;padding:.7rem 1.4rem}
    ...
    <div class="quicklinks-bar">
      <div class="inner">
        ...
        <ul class="menu-links">
          ...
          <li><a class="active" href="staff_booking.php"><i class="bi bi-calendar-check"></i>Bookings</a></li>
        ...
        <form class="row g-2 align-items-end" method="get" action="<?= $self ?>" id="dateForm">
          ...
          <div class="<?= $isDate?'':'d-none' ?>" id="dateInputs">
            ...
            <div class="col-12 mt-2">
              <button class="btn btn-primary w-100"><i class="bi bi-sliders me-1"></i>Apply</button>
            </div>
          </div>
...
<script>
  // Toggle DATE chip to show/hide date inputs (list view only)
